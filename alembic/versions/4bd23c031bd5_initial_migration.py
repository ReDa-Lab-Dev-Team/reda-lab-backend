...
Revision ID: 4bd23c031bd5
Revises: 
Create Date: 2026-02-21 01:02:22.372580
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('active', 'completed', 'paused', name='projectstatus'), nullable=False),
    ...
    sa.Column('paper_type', sa.Enum('journal', 'conference', 'book', 'report', name='papertype'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('publication_id', 'member_id')
    )
